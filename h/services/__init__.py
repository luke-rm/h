...
def includeme(config):
    ...
    config.register_service_factory('.delete_group.delete_group_service_factory', name='delete_group')
    ...
    config.register_service_factory('.group.group_members_factory', name='group_members')
    ...
    config.register_service_factory('.list_organizations.list_organizations_factory', name='list_organizations')
    ...
    config.register_service_factory('.organization.organization_factory', name='organization')
